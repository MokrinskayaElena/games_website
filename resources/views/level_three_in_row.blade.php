...
<h2>Список уровней "Три в ряд" </h2>
  ...
  <div class= "level" id="levels-container">
    <button id="level1" class="btn btn-secondary btn-sm me-2" title="Первый уровень">
        <img class="images" src="images/Three_in_row1.png" alt="Описание изображения"> 
        <!-- <br>Первый уровень -->
    </button>
    <button id="level2" class="btn btn-secondary btn-sm me-2" title="Второй уровень">
        <img class="images" src="images/Three_in_row2.png" alt="Описание изображения"> 
        <!-- <br>Второй уровень -->
    </button>
    <button id="level3" class="btn btn-secondary btn-sm me-2" title="Третий уровень">
        <img class="images" src="images/Three_in_row3.png" alt="Описание изображения"> 
        <!-- <br>Третий уровень -->
    </button>
</div>
